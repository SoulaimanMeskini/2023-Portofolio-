				...
				{MenuOpen === true && (
					<>
						<nav>
							<ul>
								<li>
									<Text id='TextChanger' to='/projects' className='link' onClick={() => navigate('/projects')}>
										Projects
									</Text>
								</li>
								<li>
									<Text id='TextChanger' to='/lookbook' className='link' onClick={() => navigate('/lookbook')}>
										Lookbook
									</Text>
								</li>
								<li>
									<Text id='TextChanger' to='/aboutme' className='link' onClick={() => navigate('/aboutme')}>
										AboutMe
									</Text>
								</li>
							</ul>
